...
import { PROVINCES } from "@/constants/account-creation";

export default function PersonalDetails({ profile, setProfile }) {
  return (
    <>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setProfile({
                    ...profile,
                    qualification: e.target.value || null,
                  })
                }
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setProfile({
                    ...profile,
                    owner_postal_code: e.target.value || null,
                  })
                }
              />
            </div>
