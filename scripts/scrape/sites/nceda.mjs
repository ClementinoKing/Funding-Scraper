...
const SOURCE = 'https://www.northern-cape.gov.za/dedat/index.php' // Updated to HTTPS

export async function scrapeNceda(browser) {
  return await crawlAndExtract(browser, SOURCE, {
    maxLinks: 10,
    delayMs: 50,
    concurrency: 6,
    keywordRegex: /(fund|loan|finance|apply|programme|program|support|sme)/i,
